        ...
        <div className='bg-[#f6eee0]  round '>
            <div className='pt-12 w-3/4 mx-auto lg:flex items-center'>
                <div className='lg:w-3/4 sm:w-4/4  '>
                    ...
                    <button className='border-1 py-2 px-6 bg-orange-500 rounded-3xl mt-4 text-white hover:bg-white hover:text-orange-600 font-semibold hover:border-orange-600'>Learn More <FontAwesomeIcon icon={faArrowRight}/></button>
                </div>
                <div>
